...
/**
 * Diagnóstico visual del agua con Claude — ESPEJO de src/services/claudeVision.ts
 * del bot (mismo prompt, mismo esquema, misma normalización). Es TAMIZAJE
 * preliminar, nunca sustituye un análisis de laboratorio.
 */
...
export async function analizarAguaConIA(
  ...
  return normalizarDiagnostico(extraerJson(bloque.text));
}
